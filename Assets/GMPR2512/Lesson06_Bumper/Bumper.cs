...
namespace GMPR2512.Lesson06
{
    ...
    public class Bumper : MonoBehaviour
    {
        ...
        void OnCollisionEnter2D(Collision2D collision)
        {
            ...
            {
                // Debug.Log("A game object with the tag {collision.collider.tag} just hit mr!");
                ...
                if (collision.rigidbody != null)
                {
                    ...
                    // Step 2: If for some reason we didn't get a contact normal, fall back (Makes the code resiliant)
